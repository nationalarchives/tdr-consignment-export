...
class MainSpec extends ExternalServiceSpec {
  ...
  "the export job" should "throw an error and call step function if the api returns no files for a 'standard' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if the api returns no files for a 'judgment' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if the FFID metadata is incomplete for a 'standard' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if the FFID metadata is incomplete for a 'judgment' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if the ffid metadata is missing for a 'standard' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if the ffid metadata is missing for a 'judgment' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if the antivirus metadata is missing for 'standard' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if the antivirus metadata is missing for 'judgment' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if no consignment metadata found" in {
    keycloakGetUser
    stepFunctionPublish
  ...
  "the export job" should "throw an error and call the step function if no valid Keycloak user found for a 'standard' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if no valid Keycloak user found for a 'judgment' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if an incomplete Keycloak user details found for a 'standard' consignment type" in {
    graphQlGetConsignmentMetadata("get_consignment_for_export.json")
  ...
  "the export job" should "throw an error and call the step function if an incomplete Keycloak user details found for a 'judgment' consignment type" in {
    graphQlGetConsignmentMetadata("get_judgment_consignment_for_export.json")
    keycloakGetIncompleteUser
    stepFunctionPublish
  ...
  "the export job" should "throw an error and call the step function if there are checksum mismatches for a 'standard' consignment type" in {
  ...
  "the export job" should "throw an error and call the step function if there are checksum mismatches for a 'judgment' consignment type" in {
