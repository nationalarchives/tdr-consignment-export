...
object Dependencies {
  ...
  lazy val awsRds = "software.amazon.awssdk" % "rds" % "2.54.17"
  ...
  lazy val catsEffectTest = "org.typelevel" %% "cats-effect-testkit" % "3.7.1"
  ...
  lazy val schemaConfig = "uk.gov.nationalarchives" %% "da-metadata-schema"% "0.0.141"
}
