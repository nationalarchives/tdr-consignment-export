...
object Dependencies {
  ...
  lazy val awsRds = "software.amazon.awssdk" % "rds" % "2.33.2"
  lazy val generatedGraphql = "uk.gov.nationalarchives" %% "tdr-generated-graphql" % "0.0.431-SNAPSHOT"
  lazy val s3Utils = "uk.gov.nationalarchives" %% "s3-utils" % awsUtilsVersion
  lazy val stepFunctionUtils = "uk.gov.nationalarchives" %% "stepfunction-utils" % "0.1.295"
  ...
  lazy val schemaConfig = "uk.gov.nationalarchives" %% "da-metadata-schema"% "0.0.93"
}
