...
object Main extends CommandIOApp("tdr-export", "Exports tdr files with a flat structure", version = "") {
  ...
  override def main: Opts[IO[ExitCode]] = exportOpts.map {
