...
class BagAdditionalFilesSpec extends ExportSpec {
  ...
  "orderedExportProperties" should "return correctly ordered properties to be included in export for a Judgment transfer" ignore {
    val expectedPropertiesOrder: List[String] = List(
      ...
      "title_closed","title_alternate","description","description_closed","description_alternate","language","end_date",
      "file_name_translation","original_identifier","parent_reference","former_reference_department","UUID","related_material",
      "judgment_type", "judgment_update", "judgment_update_type", "judgment_update_details", "judgment_neutral_citation", 
      "judgment_no_neutral_citation", "judgment_reference"
    )
  ...
  "fileMetadataCsv" should "produce a file with the correct rows for a Standard consignment" in {
    ...
    val expectedOrderedFilePropertyValues = List(
      ...
      "parentReference", "formerReferenceDepartment", "uuid", "relatedMaterial")
  ...
  "fileMetadataCsv" should "produce a file with the correct rows for a Judgment consignment" ignore {
    ...
    val expectedOrderedHeaders = List(
      ...
      "foi_exemption_asserted", "title_closed", "title_alternate", "description", "description_closed", "description_alternate",
      "language", "end_date", "file_name_translation", "original_filepath", "parent_reference", "former_reference_department", "UUID", "related_material",
      "judgment_type", "judgment_update", "judgment_update_type", "judgment_update_details", "judgment_neutral_citation", "judgment_no_neutral_citation",
      "judgment_reference"
    )
    val expectedOrderedFilePropertyValues = List(
      "fileReference", "fileName", "fileType", "1", "data/originalFilePath", "rightsCopyright", "legalStatus", "heldBy", "2021-02-03T10:33:30",
      "closureType", "2021-02-03T10:33:30", "30", "foiExemption;foiExemption2", "2021-02-03T10:33:30", "titleClosed", "titleAlternate",
      "description", "descriptionClosed", "descriptionAlternate", "language", "2021-02-03T10:33:30", "fileNameTranslation", "data/nonRedactedFilepath",
      "parentReference", "formerReferenceDepartment", "uuid", "relatedMaterial", "judgmentType", "judgmentUpdate", "judgmentUpdateType",
      "judgmentUpdateDetails", "judgmentNeutralCitation", "judgmentNoNeutralCitation", "judgmentReference"
    )
